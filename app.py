...
from google.genai import types  # নতুন কনফিগারেশনের জন্য এটি প্রয়োজন
...
st.write("Gemini API (গুগল সার্চ ও থিংকিং মোড) দ্বারা চালিত আপনার ব্যক্তিগত সহকারী।")
...
if "GEMINI_API_KEY" in st.secrets:
    ...
    API_KEY = "YOUR_GEMINI_API_KEY_HERE"  # লোকাল টেস্টের জন্য এখানে আপনার কী বসাতে পারেন
...
if user_input := st.chat_input("আমাকে যেকোনো প্রশ্ন করুন..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            # চ্যাট হিস্ট্রিকে নতুন SDK ফরম্যাটে রূপান্তর
            formatted_contents = []
            ...
            # আপনার কোড থেকে নেওয়া গুগল সার্চ এবং থিংকিং কনফিগারেশন
            ...
            # Gemini-3-flash-preview মডেল ব্যবহার করে রেসপন্স জেনারেট করা
